...
local PANEL = {}
PANEL.ColorTeamConnecting = Color(200, 120, 50, 255)
PANEL.Color1 = Color(250, 250, 245, 255)
...
function PANEL:Paint()
	...
	if self.Player:Team() == TEAM_CONNECTING then
		color = self.ColorTeamConnecting
	...
	if self.Open or self.Size != self.TargetSize then
		...
		draw.RoundedBox(4, 2, 16, self:GetWide()-4, self:GetTall() - 16 - 2, self.Color1)
